        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link to="/books" className="text-gray-600 hover:text-blue-600 transition-colors">Books</Link></li>
              <li><Link to="/stationery" className="text-gray-600 hover:text-blue-600 transition-colors">Stationery</Link></li>
              <li><Link to="/orders" className="text-gray-600 hover:text-blue-600 transition-colors">Track Order</Link></li>
